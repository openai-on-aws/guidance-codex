...
| **Portkey** | [QUICKSTART_LLM_GATEWAY_PORTKEY.md](QUICKSTART_LLM_GATEWAY_PORTKEY.md) | Hybrid gateway on Amazon EKS with Bedrock Mantle |
...
- **Portkey**: Deploy the EKS data plane and IRSA role -> configure a service-role Bedrock Mantle provider -> run the strict contract and Codex probes
